...
@Singleton
public class ETJGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class PropertyElements extends AbstractParserRuleElementFinder {
		...
		//Property:
		//	Account | AccountReport | Balance | Copyright | CellColor | Export | Flags | IcalReport | IncludeProperties | Limits
		//	| Macro | Navigator | NikuReport | ProjectIds | Rate | ResourceReport | TaskReport | TextReport | Resource | Shift |
		//	StatusSheet | StatusSheetReport | SupplementAccount | SupplementReport | SupplementResource | SupplementTask |
		//	TagFile | Task | Timesheet | TimesheetReport | ToolTip | Vacation | Leaves | Allocate;
		@Override public ParserRule getRule() { return rule; }

		//Account | AccountReport | Balance | Copyright | CellColor | Export | Flags | IcalReport | IncludeProperties | Limits |
		//Macro | Navigator | NikuReport | ProjectIds | Rate | ResourceReport | TaskReport | TextReport | Resource | Shift |
		//StatusSheet | StatusSheetReport | SupplementAccount | SupplementReport | SupplementResource | SupplementTask | TagFile
		//| Task | Timesheet | TimesheetReport | ToolTip | Vacation | Leaves | Allocate
	...
	public class LeaveDetailsElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "LeaveDetails");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class TaskAttributeElements extends AbstractParserRuleElementFinder {
		...
		//TaskAttribute:
		//	(scenario=[Scenario|QualifiedName] ":")? attr= //		AccountTask -- deprecated
		...
		//	SupplementTask | Task | Warn | MacroCall);
		@Override public ParserRule getRule() { return rule; }
	...
	public class ReportAttributeElements extends AbstractParserRuleElementFinder {
		...
		//ReportAttribute:
		//	AccountRoot | Balance | Caption | Center | Columns | CurrencyFormat | End | Epilog | Flags | Footer | Formats |
		//	Header | Headline | HideAccount | HideJournalEntry | HideResource | HideTask | JournalAttributes | JournalMode | Left
	...
	public class ResourceAttributeElements extends AbstractParserRuleElementFinder {
		...
		//	Rate | Resource | ShiftsResource | SupplementResource | VacationResource | Warn | WorkingHours | Leaves;
		@Override public ParserRule getRule() { return rule; }
	...
	public class ExtendElements extends AbstractParserRuleElementFinder {
		...
		//Extend:
		//	("reference" | "date" | "richtext" | "text") name=ID description=STRING ("{" (inherit?="inherit"? &
	...
	public class JournalEntryElements extends AbstractParserRuleElementFinder {
		...
		//JournalEntry:
		//	"journalentry" date=ISODATE headline=STRING ("{" (alert=Alert? & author=Author? & details=Details? &
		//	summary=Summary?) "}")?;
		@Override public ParserRule getRule() { return rule; }
	...
	public class LogicalPrimaryExpressionElements extends AbstractParserRuleElementFinder {
		...
		//	LogicalPrenthesizedExpression | LogicalAbsoluteIdExpression | LogicalFunctionExpression | LogicalFlagLiteral;
		@Override public ParserRule getRule() { return rule; }
	...
	public class LogicalFlagLiteralElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "LogicalFlagLiteral");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//LogicalFlagLiteral returns LogicalExpression:
	...
	public class TagFileElements extends AbstractParserRuleElementFinder {
		...
		//TagFile:
		//	"tagfile" id=ID? filename=STRING ("{" hideResource=HideResource? & hideTask=HideTask? &
		//	rollupResource=RollupResource? & rollupTask=RollupTask? "}")?;
		@Override public ParserRule getRule() { return rule; }
	...
	public class WorkingHoursElements extends AbstractParserRuleElementFinder {
		...
		//WorkingHours:
		//	"workinghours" (weekdays+=Weekdays ("," weekdays+=Weekdays)*) (off?="off" | hours+=WorkHours (","
		//	hours+=WorkHours)*);
		@Override public ParserRule getRule() { return rule; }
	...
	public class ExtendedResourceAttributeColumnElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "ExtendedResourceAttributeColumn");
	...
	public class ISODATEElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "ISODATE");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class ExtDateElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "ExtDate");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class LeaveTypeElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "LeaveType");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class BuildInMacroElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "BuildInMacro");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class JournalAttributeValuesElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "JournalAttributeValues");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		...
		//enum JournalAttributeValues:
		//	ALL="*" | NONE="-" | alert | author | date | details | flags | headline | property | propertyid | summary |
		//	timesheet;
		public EnumRule getRule() { return rule; }
	...
	public class JournalEntrySortCriterionElements extends AbstractEnumRuleElementFinder {
		...
		//	DATE_DOWN="date.down" | DATE_UP="date.up" | ALERT_DOWN="alert.down" | ALERT_UP="alert.up" |
	...
	public class ColumnIdElements extends AbstractEnumRuleElementFinder {
		...
		//enum ColumnId:
		//	activetasks | annualleave | annualleavebalance | alert | alertmessages | alertsummaries | alerttrend | balance | bsi
		//	| chart | children | closedtasks | competitorcount | competitors | complete | completed | criticalness | cost | daily
		//	| directreports | duration | duties | efficiency | effort | effortdone | effortleft | email | end | flags | followers
		//	| freetime | freework | fte | gauge | headcount | hierarchindex | hourly | id | index | inputs | journal |
		//	journal_sub | journalmessages | journalsummaries | line | managers | maxend | maxstart | minend | minstart | monthly
		//	| no | name | note | opentasks | pathcriticalness | precursors | priority | quarterly | rate | reports | resources |
		//	responsible | revenue | scenario | scheduling | seqno | sickleave | specialleave | start | status | targets |
		//	turnover | wbs | unpaidleave | weekly | yearly;
		public EnumRule getRule() { return rule; }

		//activetasks | annualleave | annualleavebalance | alert | alertmessages | alertsummaries | alerttrend | balance | bsi |
		//chart | children | closedtasks | competitorcount | competitors | complete | completed | criticalness | cost | daily |
		//directreports | duration | duties | efficiency | effort | effortdone | effortleft | email | end | flags | followers |
		//freetime | freework | fte | gauge | headcount | hierarchindex | hourly | id | index | inputs | journal | journal_sub |
		//journalmessages | journalsummaries | line | managers | maxend | maxstart | minend | minstart | monthly | no | name |
		//note | opentasks | pathcriticalness | precursors | priority | quarterly | rate | reports | resources | responsible |
		//revenue | scenario | scheduling | seqno | sickleave | specialleave | start | status | targets | turnover | wbs |
	...
	private final LeaveTypeElements unknownRuleLeaveType;
	...
	private final BuildInMacroElements unknownRuleBuildInMacro;
	...
	private final JournalAttributeValuesElements unknownRuleJournalAttributeValues;
	...
	private final PurgeReportAttributeElements unknownRulePurgeReportAttribute;
	private final PurgeResourceElements pPurgeResource;
	private final PurgeResourceAttributeElements unknownRulePurgeResourceAttribute;
	private final PurgeTaskElements pPurgeTask;
	private final PurgeTaskAttributeElements unknownRulePurgeTaskAttribute;
	...
	private final ChargeAppliesElements unknownRuleChargeApplies;
	private final JustificationElements unknownRuleJustification;
	private final JournalModeValueElements unknownRuleJournalModeValue;
	private final JournalEntrySortCriterionElements unknownRuleJournalEntrySortCriterion;
	private final ListTypeValuesElements unknownRuleListTypeValues;
	private final CriterionDirectionElements unknownRuleCriterionDirection;
	private final YesNoElements unknownRuleYesNo;
	private final ReportFormatElements unknownRuleReportFormat;
	private final LoadDisplayUnitElements unknownRuleLoadDisplayUnit;
	private final ScaleResolutionElements unknownRuleScaleResolution;
	private final SelectArgumentElements unknownRuleSelectArgument;
	private final ColumnIdElements unknownRuleColumnId;
	private final AlertLevelElements unknownRuleAlertLevel;
	private final DependsPolicyElements unknownRuleDependsPolicy;
	private final SchedulingPolicyElements unknownRuleSchedulingPolicy;
	private final TimeUnitElements unknownRuleTimeUnit;
	private final WeekdayElements unknownRuleWeekday;
	private final WorkQuantityUnitElements unknownRuleWorkQuantityUnit;
	...
	public ETJGrammarAccess(GrammarProvider grammarProvider,
		...
		this.unknownRuleLeaveType = new LeaveTypeElements();
		...
		this.unknownRuleBuildInMacro = new BuildInMacroElements();
		...
		this.unknownRuleJournalAttributeValues = new JournalAttributeValuesElements();
		...
		this.unknownRulePurgeReportAttribute = new PurgeReportAttributeElements();
		this.pPurgeResource = new PurgeResourceElements();
		this.unknownRulePurgeResourceAttribute = new PurgeResourceAttributeElements();
		this.pPurgeTask = new PurgeTaskElements();
		this.unknownRulePurgeTaskAttribute = new PurgeTaskAttributeElements();
		...
		this.unknownRuleChargeApplies = new ChargeAppliesElements();
		this.unknownRuleJustification = new JustificationElements();
		this.unknownRuleJournalModeValue = new JournalModeValueElements();
		this.unknownRuleJournalEntrySortCriterion = new JournalEntrySortCriterionElements();
		this.unknownRuleListTypeValues = new ListTypeValuesElements();
		this.unknownRuleCriterionDirection = new CriterionDirectionElements();
		this.unknownRuleYesNo = new YesNoElements();
		this.unknownRuleReportFormat = new ReportFormatElements();
		this.unknownRuleLoadDisplayUnit = new LoadDisplayUnitElements();
		this.unknownRuleScaleResolution = new ScaleResolutionElements();
		this.unknownRuleSelectArgument = new SelectArgumentElements();
		this.unknownRuleColumnId = new ColumnIdElements();
		this.unknownRuleAlertLevel = new AlertLevelElements();
		this.unknownRuleDependsPolicy = new DependsPolicyElements();
		this.unknownRuleSchedulingPolicy = new SchedulingPolicyElements();
		this.unknownRuleTimeUnit = new TimeUnitElements();
		this.unknownRuleWeekday = new WeekdayElements();
		this.unknownRuleWorkQuantityUnit = new WorkQuantityUnitElements();
	...
	public BuildInMacroElements getBuildInMacroAccess() {
		return unknownRuleBuildInMacro;
	}
	...
	public JournalAttributeValuesElements getJournalAttributeValuesAccess() {
		return unknownRuleJournalAttributeValues;
	}
	...
	public PurgeReportAttributeElements getPurgeReportAttributeAccess() {
		return unknownRulePurgeReportAttribute;
	}
	...
	public PurgeResourceAttributeElements getPurgeResourceAttributeAccess() {
		return unknownRulePurgeResourceAttribute;
	}
	...
	public PurgeTaskAttributeElements getPurgeTaskAttributeAccess() {
		return unknownRulePurgeTaskAttribute;
	}
	...
	public ChargeAppliesElements getChargeAppliesAccess() {
		return unknownRuleChargeApplies;
	}
	...
	public JournalModeValueElements getJournalModeValueAccess() {
		return unknownRuleJournalModeValue;
	}
	...
	public JournalEntrySortCriterionElements getJournalEntrySortCriterionAccess() {
		return unknownRuleJournalEntrySortCriterion;
	}
	...
	public ListTypeValuesElements getListTypeValuesAccess() {
		return unknownRuleListTypeValues;
	}
	...
	public CriterionDirectionElements getCriterionDirectionAccess() {
		return unknownRuleCriterionDirection;
	}
	...
	public ReportFormatElements getReportFormatAccess() {
		return unknownRuleReportFormat;
	}
	...
	public LoadDisplayUnitElements getLoadDisplayUnitAccess() {
		return unknownRuleLoadDisplayUnit;
	}
	...
	public ScaleResolutionElements getScaleResolutionAccess() {
		return unknownRuleScaleResolution;
	}
	...
	public SelectArgumentElements getSelectArgumentAccess() {
		return unknownRuleSelectArgument;
	}
	...
	public DependsPolicyElements getDependsPolicyAccess() {
		return unknownRuleDependsPolicy;
	}
	...
	public SchedulingPolicyElements getSchedulingPolicyAccess() {
		return unknownRuleSchedulingPolicy;
	}
	...
	public WorkQuantityUnitElements getWorkQuantityUnitAccess() {
		return unknownRuleWorkQuantityUnit;
	}
